<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/Users/usher/www/imooc_o2o/public/../application/admin/view/featured/index.html";i:1528008120;s:78:"/Users/usher/www/imooc_o2o/public/../application/admin/view/public/header.html";i:1528872089;s:78:"/Users/usher/www/imooc_o2o/public/../application/admin/view/public/footer.html";i:1486396309;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<?php if(is_array($types) || $types instanceof \think\Collection || $types instanceof \think\Paginator): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          <option value="<?php echo $key; ?>" <?php if($key == $type_id): ?> selected="selected" <?php endif; ?>><?php echo $vo; ?></option>
  ...
  <div class="mt-20">
    ...
    <?php if(is_array($featured) || $featured instanceof \think\Collection || $featured instanceof \think\Paginator): $i = 0; $__LIST__ = $featured;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr class="text-c">
          ...
          <td class="td-status"><a href="<?php echo url('featured/status'); ?>" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
          <td class="td-manage"> <a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('featured/status'); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
        </tr>
     <?php endforeach; endif; else: echo "" ;endif; ?>
      </tbody>
    </table>
  </div>
<?php echo pagination($featured); ?>
</div>
<!--包含头部文件-->
