<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/Users/usher/www/imooc_o2o/public/../application/bis/view/location/index.html";i:1527830381;s:76:"/Users/usher/www/imooc_o2o/public/../application/bis/view/public/header.html";i:1526999900;s:76:"/Users/usher/www/imooc_o2o/public/../application/bis/view/public/footer.html";i:1484472377;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<?php if(is_array($citys) || $citys instanceof \think\Collection || $citys instanceof \think\Paginator): $i = 0; $__LIST__ = $citys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      <tr class="text-c">
        ...
        <td><?php echo isMail($vo['is_main']); ?></td>
        <td class="td-status"><a href="<?php echo url('bis/location/status',['id'=>$vo['id'],'status'=>$vo['status']==1?0:1]); ?>" title="点击修改状态"><?php echo status($vo['status']); ?></a></td>
