<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/Users/usher/www/imooc_o2o/public/../application/admin/view/deal/index.html";i:1527775303;s:78:"/Users/usher/www/imooc_o2o/public/../application/admin/view/public/header.html";i:1528872089;s:78:"/Users/usher/www/imooc_o2o/public/../application/admin/view/public/footer.html";i:1486396309;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
  <div class="cl pd-5 bg-1 bk-gray mt-20">
    <div class="text-c">
      ...
      <input type="text" name="name" id="x"  value="<?php echo $name; ?>" placeholder=" 商品名称" style="width:250px" class="input-text">
      <button name="" id="ss" class="btn btn-success" type="submit"><i class="Hui-iconfont">&#xe665;</i> 搜索
      </button>
        </form>
    </div>
  </div>
  <div class="mt-20">
    <table class="table table-border table-bordered table-bg table-hover table-sort">
      ...
      <tr class="text-c">
        ...
        <td><?php echo $arrcate[$vo['category_id']]; ?></td>
        <td><?php echo $arrcity[$vo['city_id']]; ?></td>
