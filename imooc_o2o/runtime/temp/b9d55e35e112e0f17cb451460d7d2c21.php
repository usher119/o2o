<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/Users/usher/www/imooc_o2o/public/../application/admin/view/category/index.html";i:1528211103;s:78:"/Users/usher/www/imooc_o2o/public/../application/admin/view/public/header.html";i:1528872089;s:78:"/Users/usher/www/imooc_o2o/public/../application/admin/view/public/footer.html";i:1486396309;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<?php if(is_array($Category) || $Category instanceof \think\Collection || $Category instanceof \think\Paginator): $i = 0; $__LIST__ = $Category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
					...
					<td class="td-manage"><a href="<?php echo url('category/index',['parent_id'=>$vo['id']]); ?>">获取子栏目</a><a style="text-decoration:none" class="ml-5" onClick="o2o_s_edit('编辑','<?php echo url('category/edit',['id'=>$vo['id']]); ?>','')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="o2o_del('<?php echo url('category/status'); ?>')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
