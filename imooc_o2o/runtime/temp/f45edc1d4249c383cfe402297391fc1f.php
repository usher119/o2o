<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"/Users/usher/www/imooc_o2o/public/../application/admin/view/index/index.html";i:1482861584;s:78:"/Users/usher/www/imooc_o2o/public/../application/admin/view/public/header.html";i:1528872089;s:76:"/Users/usher/www/imooc_o2o/public/../application/admin/view/public/menu.html";i:1527774721;s:78:"/Users/usher/www/imooc_o2o/public/../application/admin/view/public/footer.html";i:1486396309;}*/ ?>
﻿<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo url('admin/category/index'); ?>" data-title="生活服务分类" href="javascript:void(0)">生活服务分类</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo url('admin/area/index'); ?>" data-title="城市分类" href="javascript:void(0)">城市分类</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo url('admin/bis/index'); ?>" data-title="商家列表" href="javascript:void(0)">商户列表</a></li>
					<li><a _href="<?php echo url('admin/bis/apply'); ?>" data-title="商家入驻申请" href="javascript:void(0)">商家入驻申请</a></li>
					<li><a _href="<?php echo url('admin/bis/dellist'); ?>" data-title="删除的商户" href="javascript:void(0)">删除的商户</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo url('admin/deal/index'); ?>" data-title="订单列表" href="javascript:;">订单列表</a></li>
